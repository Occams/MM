...
\usepackage{libertine,microtype,
        enumerate,amssymb,fixltx2e,listings,fancybox}
...
\frametitle{Robust Match Algorithmen -- Partielle Berechnung}
	\begin{itemize}
		\item Idee: Die \emph{relevanten} Elemente der DCT-Koeffizientenmatrix stehen "links oben". Hier werden sich also die Blöcke am wahrscheinlichsten unterscheiden.
